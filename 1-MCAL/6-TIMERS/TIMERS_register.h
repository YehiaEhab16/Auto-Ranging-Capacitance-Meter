...
#define TCCR1A				*((volatile u8*)0x4F)	//Timer/Counter1 Control
...
#define TCCR1B				*((volatile u8*)0x4E)	//Timer/Counter1 Control
...
#define TIMSK_OCIE0			1	//TTimer/Counter0 Output Compare Match Interrupt Enable
